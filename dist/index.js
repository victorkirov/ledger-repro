...
const { publicKey: nativeSegwitPubKey } = bip32.HDKey.fromExtendedKey(extendedPublicKey, testnet.bip32)
    .deriveChild(0)
    .deriveChild(0);
const keySeed = hexToBytes("ab".repeat(32));
const localRootKey = bip32.HDKey.fromMasterSeed(Buffer.from(keySeed), testnet.bip32);
...
const multisigPolicy = new WalletPolicy("multisig", "sh(multi(2,@0/**,@1/**))", [
